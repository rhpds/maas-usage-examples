...
. Run a skill by name (without `/`): `create-lab`, `create-demo`, or `verify-content`
...
* *Detailed Guide*: `.claude/INTERNAL-DEVELOPER-GUIDE.adoc` - Comprehensive documentation for RHDP content developers
